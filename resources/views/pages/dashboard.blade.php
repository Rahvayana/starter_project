                ...
                <div class="card-group hk-dash-type-2">
                    <div class="card card-sm">
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div>
                                    <span class="d-block font-15 text-dark font-weight-500">Jumlah Pelanggan</span>
                                </div>
                            </div>
                            <div>
                                <span class="d-block display-4 text-dark"><span class="counter-anim">168</span></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card card-sm">
                        <div class="card-body">
                            <div class="d-flex justify-content-between mb-5">
                                <div>
                                    <span class="d-block font-15 text-dark font-weight-500">Jumlah Barang</span>
                                </div>
                            </div>
                            <div>
                    ...
                    <div class="card card-sm">
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div>
                                    <span class="d-block font-15 text-dark font-weight-500">Jumlah Pengunjung</span>
                                </div>
                            </div>
                            <div>
                                <span class="d-block display-4 text-dark"><span class="counter-anim">168</span></span>
                    ...
                    <div class="card card-sm">
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div>
                                    <span class="d-block font-15 text-dark font-weight-500">Jumlah Merk</span>
                                </div>
                            </div>
                            <div>
                                <span class="d-block display-4 text-dark"><span class="counter-anim">18</span></span>
                            </div>
                        </div>
                    </div>
                </div>
