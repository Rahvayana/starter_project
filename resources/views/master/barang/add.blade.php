...
<section class="hk-sec-wrapper">
    ...
    <div class="row">
        <div class="col-sm">
            <form action="{{ route('master.barang.simpan') }}" method="POST" enctype="multipart/form-data">@csrf
                <meta name="csrf-token" content="{{ csrf_token() }}" />
                <div class="row">
                    <div class="col-md-6 form-group">
                        <label for="namaBarang">Nama Barang</label>
                        <input class="form-control" name="namaBarang" id="namaBarang" placeholder="Nama Barang" value="{{ old('namaBarang') }}" type="text">
                    </div>
                    <div class="col-md-6 form-group">
                        <label for="country">ID Barang</label>
                        <input class="form-control" readonly name="idBarang" id="idBarang" value="{{ old('idBarang') }}" type="text">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 form-group">
                        <label for="stok">Stok</label>
                        <input class="form-control" name="stok" id="stok" placeholder="Stok" value="{{ old('stok') }}" type="number">
                    </div>
                    <div class="col-md-6 form-group">
                ...
                <div class="row">
                    <div class="col-md-6 form-group">
                        ...
                        <input class="form-control" name="harga" id="harga" placeholder="Harga" value="{{ old('harga') }}" type="number">
                    </div>
