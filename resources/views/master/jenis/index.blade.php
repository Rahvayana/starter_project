    ...
    <div class="col-xl-12">
        <section class="hk-sec-wrapper">
            <div style="display: flex; align-items: baseline;">
                <h5 class="hk-sec-title">List Data Jenis</h5>
                <a href="{{ route('master.jenis.tambah') }}"><i class="ion ion-md-add-circle-outline ml-5" style="font-size: 24px"></i></a>
            </div>
                        ...
                        <table class="table tablesaw table-bordered table-hover  mb-0" data-tablesaw-mode="swipe" data-tablesaw-sortable data-tablesaw-sortable-switch data-tablesaw-minimap data-tablesaw-mode-switch>
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="persist">Jenis</th>
                                    <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="4">Jumlah Barang</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($types as $type) 
                                    <tr>
                                        ...
                                        <td class="title"><a href="{{ route('master.jenis.detail',$type->id) }}">{{$type->jenis}}</a></td>
